...
class penning_trap_master():
    ...
    def run_dynamics_simulation(self,n_ions=19, Vtrap=(0.0, -1750.0, -2000.0), B=4.4588, frot=180., Vwall=5., dt=5e-10, tmax=1e-6,
                       num_dump=1000):
        self.setup_crystal_and_trap(n_ions=n_ions, Vtrap=Vtrap, B=B, frot=frot, Vwall=Vwall)
